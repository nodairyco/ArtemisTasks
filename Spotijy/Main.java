...
public class Main {
    public static void main(String[] args) {
        ...
        Album fourAndAHalf = new Album("4.5", songArr1, 2016);
        ...
        Album foabp = new Album("Fear of a Blank Planet", songArr2, 2008);
        ...
        Album ITCOTCK = new Album("ITCOTCK",songs,1969);
        ...
        Album inTheWakeOfPoseidon = new Album("In the wake of poseidon", songs1,1969);
